...
class CompleteTabView extends StatelessWidget {
  CompleteTabView({Key? key}) : super(key: key);
  HomeController completeController = Get.put(HomeController());
                      ...
                      Row(
                        ...
                        children: [
                          GestureDetector(
                            onTap: () {
                              Get.toNamed(
                                  AppRoutes.leaveARestaurantReviewScreen);
                            },
                            child: Container(
