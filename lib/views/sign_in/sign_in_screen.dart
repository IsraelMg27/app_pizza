...
import 'package:foodish_delivery_flutter_ui_kit/controller/sign_in_controller.dart';
...
class _SignInScreenState extends State<SignInScreen> {
  ...
  void _showCountryPicker() async {
    ...
    if (code != null) {
      setState(() {
        signInController.selectedCountryCode = code.dialCode;
      });
    }
  }
                ...
                children: [
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(
                        horizontal: SizeConfig.kHeight35),
                    child: Text(
                            ...
                            Padding(
                              ...
                              child: GestureDetector(
                                ...
                                child: Row(
                                  children: [
                                    Text(
                                      signInController.selectedCountryCode,
                                      style: TextStyle(
                                        fontFamily:
